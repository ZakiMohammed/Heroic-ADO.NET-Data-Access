<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="HeroicApp.Add" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col">
                    <h4 class="mb-3">Heroic Data Access Add
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnSubmit" Text="Submit" CssClass="btn btn-primary" runat="server" OnClick="btnSubmit_Click" OnClientClick="return confirm('Are your sure you want to save?');" />
